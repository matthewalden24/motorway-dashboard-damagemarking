...
function openDamageModal() {
  ...
  if (!state.aiSuggestionsShown) {
    ...
    state.aiSuggestions = [
      ...
      { id: 'ai-4', type: 'Scratch or scuff', size: 'Medium', location: 'Front bumper', isAi: true, photoIndex: 0, rect: { leftPct: 70.1, topPct: 68.5, widthPct: 9.5, heightPct: 9.5 }, crop: { x: 0.701, y: 0.685, w: 0.095, h: 0.095 } }
    ];
  }
