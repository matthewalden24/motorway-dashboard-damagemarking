...
function openDamageModal() {
  ...
  if (!state.aiSuggestionsShown) {
    ...
    state.aiSuggestions = [
      ...
      { id: 'ai-4', type: 'Scratch or scuff', size: 'Medium', location: 'Front bumper', isAi: true, photoIndex: 0, rect: { leftPct: 71.3, topPct: 68.5, widthPct: 6.8, heightPct: 7.1 }, crop: { x: 0.713, y: 0.685, w: 0.068, h: 0.071 } }
    ];
  }
