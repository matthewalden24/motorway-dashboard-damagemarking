...
function openDamageModal() {
  ...
  if (!state.aiSuggestionsShown) {
    ...
    state.aiSuggestions = [
      { id: 'ai-1', type: 'Dent', size: 'Small', location: 'Driver door', isAi: true, photoIndex: 0, rect: { leftPct: 11.6, topPct: 39.6, widthPct: 6.8, heightPct: 7.1 }, crop: { x: 0.116, y: 0.396, w: 0.068, h: 0.071 } },
